...
namespace Pascu_Ioana_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Pascu_Ioana_Lab8Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Pascu_Ioana_Lab8Context context, string[] selectedCategories, Book bookToUpdate)
        {
